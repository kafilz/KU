...
<tr>
 <td width="25%" align="left"><strong>LANGUAGE CORE COURSE</strong></td>   
 <td width="26%" align="left"><?php echo $subjects[substr($_POST['lcc'],0,3)];?></td>
<td  width="45%" align="left"><?php echo $subjects[substr($_POST['lcc'],0,3)];?>
    <!--<table width="100%" border="0" cellspacing="2" cellpadding="3" align="center">
      <?php
      $course_sql = "SELECT * FROM subject_papers WHERE subject = '".$_POST['lcc']."'";
      $course_rst = mysql_query($course_sql);
      while($course_row = @mysql_fetch_array($course_rst)){
      ?>
    <tr>
...
<a href="user_exam_form.php?main_subject=<?php echo $_POST["main_subject"];?>&generic=<?php echo $_POST["generic"];?>&skill=<?php echo $_POST["skill"];?>&lcc=<?php echo $_POST["lcc"];?>&other_subject=<?php echo $_POST["other_subject"];?>&other_subject1=<?php echo $_POST["other_subject1"];?>&other_subject2=<?php echo $_POST["other_subject2"];?>&updation=<?php echo $_POST["updation"];?>" style="text-decoration:none;">
