                          ...
                          <tr>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="1">
							 ...
							 <td width="5%" height="12"  valign='top'>&nbsp;</td>
							  ...
							  <?php if($_SESSION["export"] == false && $_SESSION["USERNAME"] != 'goodyear' && $_SESSION["USERNAME"] != 'bridgestone'){ $chkk = ' CHECKED';$enabb='';}else{$chkk = '';$enabb=' DISABLED';}?>
							<input type="checkbox" name="check_uncheck0" id="check_uncheck0" value="" style="width:15px;" onclick="checkedAll(this.id,'VKORG',this.form)" <?php echo $chkk.$enabb;?> />						     </td>
...
?>
							...
							<tr>
							  <td height="12"  valign='top'>&nbsp;</td>
							  <td colspan="2" align="left"><input type="button" name="Submit" value="Submit" id="Submit" onclick="report_param01('<?php echo $_REQUEST['target']?>');"  style="width:52px; height:20px;"/>
							    &nbsp;
